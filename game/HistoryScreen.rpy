...
init -3 python:
    ...
    # styles
    style.readback_window.xmaximum = 950
    style.readback_window.ymaximum = 450
    style.readback_window.align = (.5, 0.5)
    style.readback_window.background = None

    style.readback_frame.background = None
    style.readback_frame.xpadding = 10
    style.readback_frame.xmargin = 10
    style.readback_frame.ymargin = 5

    style.readback_text.color = "#545454"
    ...
    # style.readback_text.color = "ffffff" # This is your speaking text.
...
screen text_history:
    ...
    add "images/MenuItems/BacklogBG.png"
