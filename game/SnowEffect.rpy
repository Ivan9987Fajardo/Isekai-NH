init python:
    ...
    # Snow particles
    # ----------------
    def Snow(image, max_particles=300, speed=250, wind=100, xborder=(0,100), yborder=(50,400), **kwargs):
        """
    ...
    class SnowParticle(object):
        ...
        def update(self, st):
            ...
            if self.ypos < -50 or\
               (self.wind< 0 and self.xpos<-50) or (self.wind > 0 and self.xpos > renpy.config.screen_width):
                ##  print "Dead"
                return None
