...
define config.name = _("Isekai: New Horizons")
...
define config.after_load_transition = blinds
...
define config.save_directory = "IsekaiNewHorizon"
...
define config.window_icon = "images/MenuItems/icon.png"
...
init python:
    ...
    # style.imagemap.activate_sound = "sounds/Quirky33.mp3"
